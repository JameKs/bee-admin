...
import { Card, Row, Col, Radio, Input, List, Menu, Dropdown, Icon, Spin, Progress } from 'antd';
...
class CardList extends PureComponent {
  ...
  componentWillMount() {
    ...
    this.props.dispatch({ type: LIST_CARD_INIT, payload: { params } });
  }
  ...
  handlePageChange = (page, pageSize) => {
    ...
    this.props.dispatch({ type: LIST_CARD_GET, payload: { params } });
  }
  ...
  handleApproved = (item) => {
    this.props.dispatch({ type: LIST_CARD_APPROVED, payload: { approvalNo: item.approvalNo, handleApprovedSucc: this.handleApprovedSucc } });
  }
                  ...
                  description={(
                    <Ellipsis className={styles.item}>{
                      <div>
                        ...
                        <div>
                          <span>开始时间：</span>
                          {ParseUtils.parseDateTimeString(item.createdAt, 'YYYY-MM-DD', 'YYYY-MM-DD hh:mm')}
                        </div>
                        <div>
                          <span>提交员工：</span>{item.submitter}
                        </div>
                        <div>
                          <span>审批进度：</span>
